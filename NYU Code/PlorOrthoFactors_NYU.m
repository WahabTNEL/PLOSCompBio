...
cl=length(seqTrain)/4;
trueYtrain=[ones(1,cl) 2*ones(1,cl) 3*ones(1,cl) 4*ones(1,cl)];
...
CellTV{1}=[seqTrain(find(trueYtrain==4)).xorth];
...
[ Pxx_all_tv, ~, f]=PwelchCell(CellTV, windowsize, overlap, fs, tr);
%
